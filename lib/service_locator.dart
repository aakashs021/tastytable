...
import 'package:tastytable/features/auth/domain/usecase/forgot_password_usecase.dart';
...
import 'package:tastytable/features/search/data/repository/search_repository_impl.dart';
...
class ServiceLocator {
  ...
  static Future<void> initializeDependencies() async {
    ...
    sl.registerLazySingleton<UsecaseForgotPassword>(() => ForgotPasswordUsecase());
